...
async function Detail(){
  companyName1.companyName = companyName.value
}
...
async function SendApply() {
  ...
  let apply = {
    ...
    campusRecruitmentId: campusRecruitment.campusRecruitmentList[workId.campusRecruitmentId].campusRecruitmentId,
    status: 'under review'
  };
        ...
        <img src="/img/14.jpg" alt="Custom Image"><br>      
            ...
            <div class="main">
                <el-descriptions                  
                    ...
                    :style="blockMargin"
                >
                    <el-descriptions-item label="WorkingTitle" :span="1" >{{campusRecruitment.campusRecruitmentList[workId.campusRecruitmentId].workingTitle}}</el-descriptions-item>
                    <el-descriptions-item label="Salary and Benefits" :span="2">{{campusRecruitment.campusRecruitmentList[workId.campusRecruitmentId].salary}}</el-descriptions-item>
                    <el-descriptions-item label="Academic Qualifications" :span="2">{{campusRecruitment.campusRecruitmentList[workId.campusRecruitmentId].education}}</el-descriptions-item>
                    <el-descriptions-item label="Address"
                    >{{campusRecruitment.campusRecruitmentList[workId.campusRecruitmentId].addressDetails}}
                    </el-descriptions-item>
                    <el-descriptions-item label="Work City" :span="2">{{campusRecruitment.campusRecruitmentList[workId.campusRecruitmentId].workCity}}</el-descriptions-item>
                    <el-descriptions-item label="Number of Recruits" :span="2">{{campusRecruitment.campusRecruitmentList[workId.campusRecruitmentId].count}}</el-descriptions-item>
                ...
                <div style="margin-top: 30px;">
                    ...
                    <el-descriptions :column="1" border>
                        ...
                        <el-descriptions-item label="Type of Position" label-align="center" align="center">
                            {{campusRecruitment.campusRecruitmentList[workId.campusRecruitmentId].position}}
                        </el-descriptions-item>
                        <el-descriptions-item label="Type of Industry" label-align="center" align="center">
                            {{campusRecruitment.campusRecruitmentList[workId.campusRecruitmentId].industry}}
                        </el-descriptions-item>
                        <el-descriptions-item label="Work Content" label-align="center" align="center">
                            {{campusRecruitment.campusRecruitmentList[workId.campusRecruitmentId].workContent}}
                        </el-descriptions-item>
                        <el-descriptions-item label="Job Requirements" label-align="center" align="center">
                            {{campusRecruitment.campusRecruitmentList[workId.campusRecruitmentId].jobRequirements}}
                        </el-descriptions-item>
                        <el-descriptions-item label="Work Experience Requirements" label-align="center" align="center">
                            {{campusRecruitment.campusRecruitmentList[workId.campusRecruitmentId].experience}}
                        </el-descriptions-item>
                    </el-descriptions>
                </div>
                <div class="company">
                Job Poster:   {{EmployerName}}
                 <br>      
