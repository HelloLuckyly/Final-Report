...
//     }
// }
// async function showSearchByIndustryList()() {
    ...
    <div class="common-layout">
      <el-container>
        ...
        <img src="/img/14.jpg" alt="Custom Image"><br>      
            ...
            <template #append>
                <el-button @click="SearchSomething()"  :icon="Search" />
            </template>
            </el-input>
        </div>
        </el-header>
        ...
        <el-container>
            ...
            <el-footer class="footer">
                ...
                <div class="flexbox">
                  <div class="part" v-for="searchByIndustry,index in searchByIndustry.searchByIndustryList" :key="index">
                    <router-link to="/recruitmentDetail">
                      <el-button class="elBtu" @click="savaInfo(index)">
                       <text class="elBtu1" >{{ searchByIndustry.position }}</text>           
                      <text class="elBtu2">{{ searchByIndustry.industry }}</text> 
                       <text class="elBtu3">{{ searchByIndustry.workCity }}</text> 
                      </el-button>
                  </router-link>
                  </div>
                </div>
